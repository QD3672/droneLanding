...
class CustomEnv(gym.Env):
    ...
    def reset(self, seed=None, options=None):
        ...
        self.multirotor_client.takeoffAsync(timeout_sec = 2, vehicle_name = self.agent_name)
    ...
    def __get_new_start_locations(self):
        ...
        if random_choice == 1:
            return np.random.uniform(low=(-40, -10,-10), high=(-25, 10,-2), size=(3,))
        elif random_choice == 2:
            return np.random.uniform(low=(35, -100,-5), high=(50, -80,-4), size=(3,))
        else:
